...
const Projects = () => {
  const projects = [
    ...
    {
      title: "Collage Creation App",
      description: "Developed UI/UX for a mobile collage creation application with drag-and-drop functionality, templates, and social sharing features. Focus on creative workflow optimization.",
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <button className="w-full flex items-center justify-center gap-2 py-3 bg-pink-600 text-white rounded-xl font-medium hover:bg-pink-700 transition-colors duration-200 group">
