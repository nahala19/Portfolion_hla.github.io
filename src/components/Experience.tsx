...
const Experience = () => {
  ...
  const certifications = [
    ...
    {
      title: 'DCSP (Diploma in Computerised Software Package)',
      issuer: 'Microsoft Office',
      date: '2023',
      description: 'Specialized certification in Microsoft Office suite including Word, Excel, PowerPoint, and Outlook. Mastered advanced features for professional document creation, data analysis, and presentation design.'
    },
  ];
